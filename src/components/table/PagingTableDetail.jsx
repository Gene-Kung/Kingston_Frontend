...
export const PagingTableDetail = ({ columns, resData, handlePaging, handleEdit, handleDelete, handleDetail }) => {
    const { loginStatus } = useAPI();
                                ...
                                <TableBody>
                                    {
                                        list.map((row, index) => (
                                            <TableRow key={row.id}>
                                                ...
                                                <TableCell>
                                                    <IconButton onClick={() => handleClickDetail(row)}>
...
export default React.memo(PagingTableDetail);